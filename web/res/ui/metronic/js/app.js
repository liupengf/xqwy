...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                //pageContentBody.removeClass('pt-page-rotateSlideIn');
                //pageContentBody.addClass('pt-page-rotateSlideOut');
             
        		
                $.post(url,function (data) {
                	    //pageContentBody.removeClass('pt-page-rotateSlideOut');
                		//pageContentBody.addClass('pt-page-rotateSlideIn');
                		//App.unblockUI(pageContent);
                        pageContentBody.html(data);

                        App.fixContentHeight(); // fix content height
                        //App.initUniform(); // initialize uniform elements
                }).error(function(XmlHttpRequest,textStatus, errorThrown) {pageContentBody.html(XmlHttpRequest.responseText);});
        });
    }
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('click', '.sidebar-toggler', function (e) {        
        	//$('.page-sidebar').children(":first").hide();
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="/res/ui/plugins/jquery.showLoading/showLoading.gif" align="">',
