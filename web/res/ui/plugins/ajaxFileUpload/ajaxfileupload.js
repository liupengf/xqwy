jQuery
		.extend({
			...
			createUploadForm : function(id, data) {
				 ...
				 * jQuery(form).css('top', '-1200px'); jQuery(form).css('left',
				 * '-1200px'); jQuery(form).appendTo('body'); return form;
				 */
				return form;
			},
			...
			ajaxFileUpload : function(s) {
				...
				var frameId = 'jUploadFrame' + now;

				var form = jQuery.createUploadForm(formId,
						(typeof (s.data) == 'undefined' ? false : s.data));
				var io = jQuery.createUploadIframe(now, s.secureuri);
