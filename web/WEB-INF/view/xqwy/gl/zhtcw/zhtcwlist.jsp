<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<a id="searchzhtcwButton" class="btn" href="javaScript:void(0)" style="float: right;">查询</a>
	</div>
	<div class="span4">
		<a id="addzhtcw" class="btn" href="javaScript:void(0)" style="float: left;">添加</a>
	</div>
	</div>
	...
	<script
	src="${baseUrl}/res/js/xqwy/gl/zhtcw/zhtcwlist.js"
